...
def Database():
    conn = sqlite3.connect("../project/pythontut.db")
    cursor = conn.cursor()
    cursor.execute(
...
def OnSelected(event):
    ...
    Male = Radiobutton(RadioGroup, text="Male", variable=GENDER, value="1", font=('arial', 14))
    Male.pack(side='left')

    Female = Radiobutton(RadioGroup, text="Female", variable=GENDER, value="2", font=('arial', 14))
